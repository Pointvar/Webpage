...
def process_main(env_type):
    org_url_one = "compass_warp/conf/{env_type}/settings.py".format(env_type=env_type)
    dst_url_one = "compass_warp/compass/settings.py"
    org_url_two = "compass_warp/db_models/conf/{env_type}/settings.py".format(env_type=env_type)
    dst_url_two = "compass_warp/db_models/conf/settings.py"
